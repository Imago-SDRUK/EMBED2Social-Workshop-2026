...
Imago Data Product: [URL]

### Steps
1. Open Geopackages (2020 or 2024)
2. Explore Layer Properties - CRS, format, fields and their types
3. Create a style for geopackage to illustrate the spatial differences for the first band
 (Symbology -> Layer Properties -> Graduated -> 20 classes -> Histogram)
4. Repeat for the second and third bands
5. Do you see the visual difference?

----

### Steps
6. Visualise layer with 50% transparency over OSM or Google Satellite background (use `QuickOSM` plugin)
7. Find an outskirt LSOA ([`data_zone_code = E01002292`]{.orange}) and Westminster LSOA ([`data_zone_code = E01004690`]{.orange}). 

How different are they?

---

![](assets/figures/lab1_exercise1_screen1.png){ width=100% fig-alt="Geospatial cube" fig-align="left" }
...
<QGIS Screenshot>
4. Each LSOA has the unique `data_zone_code`
<QGIS Screenshot>
...
::: {.column width="35%"}
6. In the output dataset, open Field Calculator and calculate the difference between 2024 and 2020 for the third dimension (`A02_mean`)
:::
...
## Exercise 5. [Extra - PENDING] 'Ground' Embeddings <!-- (15min) -->
...
<!--  Calculate correlation between embed values and population density from ONS - TODO 
...
# Thanks! You will have another portion of exercises soon...
